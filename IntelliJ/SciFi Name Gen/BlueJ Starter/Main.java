...
public class Main {
    ...
    public static void main()
    {
        ...
        String lastRel1 = relativeName1.substring(random1-1);
        String lastRel2 = relativeName2.substring(random2-1);

        String sciLoc = lastRel1 + lastRel2;
        String scifLower = sciFirst.toLowerCase();
        String scilLower = sciLast.toLowerCase();
        String scilocLower = sciLoc.toLowerCase();

        String realFirst = scifLower.substring(0,1).toUpperCase() + scifLower.substring(1);
        String realLast = scilLower.substring(0,1).toUpperCase() + scilLower.substring(1);
        String realLoc = scilocLower.substring(0,1).toUpperCase() + scilocLower.substring(1);

        System.out.println("Welcome," + " " + realFirst + " " + realLast + " " + "of" + " " + realLoc + "." );
