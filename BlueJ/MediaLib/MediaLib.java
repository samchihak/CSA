...
public class MediaLib
{
    public static void main ()
    {
        ...
        Film film2 = new Film("Heat (1995)", 10, 120);
        Film film3 = new Film("The Godfather Part II (1974)",10, 120);
        Film film4 = new Film("Full Metal Jacket (1987)", 9, 120);
        Film film5 = new Film("Reservoir Dogs (1992)", 9,120);
        Film film6 = new Film("The Big Lebowski (1998)", 8, 120);
        Film film7 = new Film("Casino (1995)", 8, 120);
        Film film8 = new Film("Animal House (1978)", 8,120);
